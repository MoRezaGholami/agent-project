بفرمایید! این کل متن فایل `README.md` هست. می‌تونی با استفاده از دکمه کپی (Copy) در گوشه این باکس، تمام متن رو یکجا کپی کنی و داخل فایلت پیست کنی:
...
1. Clone the repository:
   ```bash
   git clone [https://github.com/MoRezaGhoami/agent-project.git](https://github.com/MoRezaGholami/agent-project.git)
   cd agent-project
